...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      let nombreamis = this.amigos.map(function(objeto){
    ...
    getPromedioEdad() {
      ...
      let edadamis = this.amigos.map(function(objeto){
        return objeto.edad;
      }) 
      return edadamis.reduce((accumulator, currentValue) => accumulator + currentValue) / edadamis.length ;
